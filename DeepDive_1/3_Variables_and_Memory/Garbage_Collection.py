...
# As we can see, the reference counts are now both equal to 1 (a pure circular reference), and
# reference counting alone did not destroy the A and B instances - they're still around. 
